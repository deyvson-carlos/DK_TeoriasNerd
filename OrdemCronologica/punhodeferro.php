...
<head>
    ...
    <title>Teorias Nerd/Séries/Punho De Ferro</title>
...
<div class="container my-5">
  ...
  <div
    ...
    style="
      background-image: url('../img/series/PunhoDeFerro/principal.png');
      height: 400px;
      width: 100%;"
  >
    <div class="mask" style="background-color: rgba(0, 0, 0, 0.6);">
      <div class="d-flex justify-content-center align-items-center h-100">
        <div class="text-white">
          ...
          <h4 class="mb-3">Punho De Ferro</h4>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="row">
          <div class="col-md-6 gx-5 mb-4">
            <div class="bg-image hover-overlay ripple shadow-2-strong rounded-5" data-mdb-ripple-color="light">
              <img src="../img/series/PunhoDeFerro/banner.jpg" class="img-fluid" />
              <a href="#!">
          ...
          <div class="col-md-6 gx-5 mb-4">
            <h4><strong>Punho De Ferro</strong></h4>
            <p class="text-muted">
            Punho de Ferro da Marvel , ou simplesmente Punho de Ferro , é uma série de televisão baseada no super-herói da Marvel Comics de mesmo nome . É a sexta série de televisão do Universo Cinematográfico Marvel . A série foi produzida pela Marvel Television e lançada originalmente na Netflix .
            </p>
            <p><strong>A primeira temporada foi lançada em 17 de março de 2017. A segunda e última temporada foi lançada em 7 de setembro de 2018.</strong></p>
            <p class="text-muted">
            Depois que sua família encontra um destino trágico durante uma expedição na China , um jovem Rand é adotado pelo povo da mística cidade perdida de K'un-Lun , onde ele aprendeu um estilo de luta mágico.
            </p>
          </div>
        </div>
      </section>
...
<div class="row row-cols-1 row-cols-md-3 g-4" >
  <div class="col">
    <div class="card h-100 hover-zoom">
      <img src="../img/series/PunhoDeFerro/01.jpg" class="card-img-top" alt="Hollywood Sign on The Hill"/>
      <div class="card-body">
        <ul class="mb-0 ms-2">
                    <li class="my-3">
                    Primeira temporada
  ...
  <div class="col">
    <div class="card h-100 hover-zoom">
      <img src="../img/series/PunhoDeFerro/02.jpg" class="card-img-top" alt="Palm Springs Road"/>
      <div class="card-body">
      <ul class="mb-0 ms-2">
                    <li class="my-3">
                    Segunda temporada
                    ...
                    <li class="my-3">
                    Execução: 7 de setembro de 2018
                    </li>
                  </ul>
      </div>
    </div>
