...
<head>
    ...
    <title>Teorias Nerd | Séries | Invasão Secreta</title>
...
<div class="container my-5">
  ...
  <div
    ...
    style="
      background-image: url('../img/series/invasaosecreta/principal.jpg');
      height: 400px;
      width: 100%;"
  >
    <div class="mask" style="background-color: rgba(0, 0, 0, 0.6);">
      <div class="d-flex justify-content-center align-items-center h-100">
        <div class="text-white">
          ...
          <h4 class="mb-3">Invasão Secreta</h4>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="row">
          <div class="col-md-6 gx-5 mb-4">
            <div class="bg-image hover-overlay ripple shadow-2-strong rounded-5" data-mdb-ripple-color="light">
              <img src="../img/series/invasaosecreta/banner.png" class="img-fluid" />
              <a href="#!">
          ...
          <div class="col-md-6 gx-5 mb-4">
            <h4><strong>Invasão Secreta</strong></h4>
            <p class="text-muted">
            Secret Invasion é uma próxima série de televisão na web americana, baseada no evento de crossover da Marvel Comics de mesmo nome . A série é uma sequência de Capitã Marvel e Homem-Aranha: Longe de Casa . É a vigésima terceira série de televisão do Universo Cinematográfico Marvel e a segunda parcela da Fase Cinco . A série é produzida pela Marvel Studios e será lançada no Disney+ . 
            </p>
            <p><strong>A primeira temporada consistirá em seis episódios e estreia na primavera de 2023.</strong></p>
            <p class="text-muted">
            Esta série é estrelada por Samuel L. Jackson como Nick Fury e Ben Mendelsohn como os Skrull Talos – personagens que se conheceram em Capitã Marvel . A série de eventos de quadrinhos crossover mostra uma facção de Skrulls que mudam de forma que se infiltram na Terra há anos.
            </p>
          </div>
        </div>
      </section>
...
<div class="row row-cols-1 row-cols-md-3 g-4" >
  <div class="col">
    <div class="card h-100 hover-zoom">
      <img src="../img/series/invasaosecreta/01.jpg" class="card-img-top" alt="Hollywood Sign on The Hill"/>
      <div class="card-body">
        <ul class="mb-0 ms-2">
                    <li class="my-3">
                    Primeira temporada
