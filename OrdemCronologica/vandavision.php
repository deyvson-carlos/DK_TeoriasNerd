...
<head>
    ...
    <title>Teorias Nerd | Séries | VandaVision</title>
...
<div class="container my-5">
  ...
  <div
    ...
    style="
      background-image: url('../img/series/VandaVision/principal.jpg');
      height: 400px;
      width: 100%;"
  >
        ...
        <div class="row">
          <div class="col-md-6 gx-5 mb-4">
            <div class="bg-image hover-overlay ripple shadow-2-strong rounded-5" data-mdb-ripple-color="light">
              <img src="../img/series/VandaVision/banner.jpg" class="img-fluid" />
              <a href="#!">
          ...
          <div class="col-md-6 gx-5 mb-4">
            <h4><strong>WandaVisionk</strong></h4>
            <p class="text-muted">
            WandaVision é uma minissérie americana de televisão na web, baseada nos super-heróis da Marvel Comics, Feiticeira Escarlate e Visão . A série é uma continuação de Vingadores: Ultimato . É a décima terceira série de televisão do Universo Cinematográfico Marvel , e a primeira parcela da Fase Quatro e da Saga Multiverso . A série foi produzida pela Marvel Studios e foi lançada no Disney+ .
            </p>
            <p><strong>A primeira e única temporada estreou em 15 de janeiro de 2021 e foi concluída em 5 de março de 2021.</strong></p>
            <p class="text-muted">
            WandaVision da Marvel Studios combina o estilo das comédias clássicas com o Universo Cinematográfico da Marvel em que Wanda Maximoff e Vision – dois seres superpoderosos vivendo sua vida suburbana ideal – começam a suspeitar que nem tudo é o que parece.  
            </p>
          </div>
        </div>
      </section>
...
<div class="row row-cols-1 row-cols-md-3 g-4" >
  <div class="col">
    <div class="card h-100 hover-zoom">
      <img src="../img/series/VandaVision/01.jpg" class="card-img-top" alt="Hollywood Sign on The Hill"/>
      <div class="card-body">
        <ul class="mb-0 ms-2">
                    <li class="my-3">
                    Primeira temporada
                    ...
                    <li class="my-3">
                    Execução: 15 de janeiro de 2021 - 5 de março de 2021
                    </li>
                  </ul>
      </div>
    </div>
