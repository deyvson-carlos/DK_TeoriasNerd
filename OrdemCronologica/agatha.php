...
<head>
    ...
    <title>Teorias Nerd | Séries | Agatha</title>
...
<div class="container my-5">
  ...
  <div
    ...
    style="
      background-image: url('../img/series/Agatha/principal.jpg');
      height: 400px;
      width: 100%;"
  >
        ...
        <div class="row">
          <div class="col-md-6 gx-5 mb-4">
            <div class="bg-image hover-overlay ripple shadow-2-strong rounded-5" data-mdb-ripple-color="light">
              <img src="../img/series/Agatha/banner.png" class="img-fluid" />
              <a href="#!">
          ...
          <div class="col-md-6 gx-5 mb-4">
            <h4><strong>Agatha: Coven do Caos</strong></h4>
            <p class="text-muted">
            Agatha: Coven of Chaos é uma série de televisão na web americana, baseada no supervilão da Marvel Comics de mesmo nome . A série é um spin-off de WandaVision . É a vigésima sexta série de televisão do Universo Cinematográfico Marvel e a nona parcela da Fase Cinco . A série é produzida pela Marvel Studios e será lançada no Disney+ .
            </p>
            <p><strong>A primeira temporada vai estrear no inverno de 2023.</strong></p>
            <p class="text-muted">
            Agatha: House of Harkness revelará mais sobre o personagem introduzido pela primeira vez em WandaVision da Marvel Studios . 
            </p>
          </div>
        </div>
      </section>
...
<div class="row row-cols-1 row-cols-md-3 g-4" >
  <div class="col">
    <div class="card h-100 hover-zoom">
      <img src="../img/series/Agatha/01.jpg" class="card-img-top" alt="Hollywood Sign on The Hill"/>
      <div class="card-body">
        <ul class="mb-0 ms-2">
                    <li class="my-3">
                    Primeira temporada
