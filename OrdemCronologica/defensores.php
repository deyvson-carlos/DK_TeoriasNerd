...
<head>
    ...
    <title>Teorias Nerd | Séries | Os Defensores</title>
...
<div class="container my-5">
  ...
  <div
    ...
    style="
      background-image: url('../img/series/OsDefensores/01.jpg');
      height: 400px;
      width: 100%;"
  >
    <div class="mask" style="background-color: rgba(0, 0, 0, 0.6);">
      <div class="d-flex justify-content-center align-items-center h-100">
        <div class="text-white">
          ...
          <h4 class="mb-3">Os Defensores</h4>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="row">
          <div class="col-md-6 gx-5 mb-4">
            <div class="bg-image hover-overlay ripple shadow-2-strong rounded-5" data-mdb-ripple-color="light">
              <img src="../img/series/OsDefensores/banner.jpg" class="img-fluid" />
              <a href="#!">
          ...
          <div class="col-md-6 gx-5 mb-4">
            <h4><strong>Os Defensores</strong></h4>
            <p class="text-muted">
            Os Defensores da Marvel , ou simplesmente Os Defensores , é uma minissérie de televisão baseada na equipe da Marvel Comics de mesmo nome . É a sétima série de televisão do Universo Cinematográfico Marvel . A série foi produzida pela Marvel Television e lançada originalmente na Netflix .
            </p>
            <p><strong>A primeira e única temporada foi lançada em 18 de agosto de 2017.</strong></p>
            <p class="text-muted">
            Os Defensores da Marvel segue Demolidor , Jessica Jones , Luke Cage e Punho de Ferro . Um quarteto de heróis singulares com um objetivo comum - salvar a cidade de Nova York . Esta é a história de quatro figuras solitárias, sobrecarregadas com seus próprios desafios pessoais, que percebem que podem ser mais fortes quando unidas.
            </p>
          </div>
        </div>
      </section>
...
<div class="row row-cols-1 row-cols-md-3 g-4" >
  <div class="col">
    <div class="card h-100 hover-zoom">
      <img src="../img/series/OsDefensores/01.jpg" class="card-img-top" alt="Hollywood Sign on The Hill"/>
      <div class="card-body">
        <ul class="mb-0 ms-2">
                    <li class="my-3">
                    Primeira temporada
