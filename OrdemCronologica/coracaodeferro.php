...
<head>
    ...
    <title>Teorias Nerd | Séries | Coração de Ferro</title>
...
<div class="container my-5">
  ...
  <div
    ...
    style="
      background-image: url('../img/series/coracaodeferro/principal.jpg');
      height: 400px;
      width: 100%;"
  >
    <div class="mask" style="background-color: rgba(0, 0, 0, 0.6);">
      <div class="d-flex justify-content-center align-items-center h-100">
        <div class="text-white">
          ...
          <h4 class="mb-3">Coração de Ferro</h4>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="row">
          <div class="col-md-6 gx-5 mb-4">
            <div class="bg-image hover-overlay ripple shadow-2-strong rounded-5" data-mdb-ripple-color="light">
              <img src="../img/series/coracaodeferro/banner.png" class="img-fluid" />
              <a href="#!">
          ...
          <div class="col-md-6 gx-5 mb-4">
            <h4><strong>Coração de Ferro</strong></h4>
            <p class="text-muted">
            Ironheart é uma próxima série de televisão na web americana, baseada na super-heroína da Marvel Comics de mesmo nome . A série é uma continuação de Black Panther: Wakanda Forever . É a vigésima quarta série de televisão do Universo Cinematográfico Marvel e a oitava parcela da Fase Cinco . A série é produzida pela Marvel Studios e Proximity Media e será lançada no Disney+ . 
            </p>
            <p><strong>A primeira temporada consistirá em seis episódios e estreia no outono de 2023.</strong></p>
            <p class="text-muted">
...
<div class="row row-cols-1 row-cols-md-3 g-4" >
  <div class="col">
    <div class="card h-100 hover-zoom">
      <img src="../img/series/coracaodeferro/01.jpg" class="card-img-top" alt="Hollywood Sign on The Hill"/>
      <div class="card-body">
        <ul class="mb-0 ms-2">
                    <li class="my-3">
                    Primeira temporada
