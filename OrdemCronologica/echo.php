...
<head>
    ...
    <title>Teorias Nerd | Séries | Echo</title>
...
<div class="container my-5">
  ...
  <div
    ...
    style="
      background-image: url('../img/series/Echo/principal.jpg');
      height: 400px;
      width: 100%;"
  >
        ...
        <div class="row">
          <div class="col-md-6 gx-5 mb-4">
            <div class="bg-image hover-overlay ripple shadow-2-strong rounded-5" data-mdb-ripple-color="light">
              <img src="../img/series/Echo/banner.jpeg" class="img-fluid" />
              <a href="#!">
          ...
          <div class="col-md-6 gx-5 mb-4">
            <h4><strong>Echo</strong></h4>
            <p class="text-muted">
            Echo é uma série de televisão na web americana, baseada no super-herói da Marvel Comics de mesmo nome . A série é um spin-off e uma sequência de Gavião Arqueiro . É a vigésima segunda série de televisão do Universo Cinematográfico Marvel e a quarta parcela da Fase Cinco . A série é produzida pela Marvel Studios e será lançada no Disney+ . 
            </p>
            <p><strong>A primeira temporada vai estrear no verão de 2023.</strong></p>
            <p class="text-muted">
            A história de origem de Echo revisita Maya Lopez , cujo comportamento implacável em Nova York a alcança em sua cidade natal. Ela deve enfrentar seu passado, se reconectar com suas raízes nativas americanas e abraçar o significado de família e comunidade se ela quiser seguir em frente.
            </p>
          </div>
        </div>
      </section>
...
<div class="row row-cols-1 row-cols-md-3 g-4" >
  <div class="col">
    <div class="card h-100 hover-zoom">
      <img src="../img/series/Echo/01.jpg" class="card-img-top" alt="Hollywood Sign on The Hill"/>
      <div class="card-body">
        <ul class="mb-0 ms-2">
                    <li class="my-3">
                    Primeira temporada
