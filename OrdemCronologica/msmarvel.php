...
<head>
    ...
    <title>Teorias Nerd | Séries | Ms Marvel</title>
...
<div class="container my-5">
  ...
  <div
    ...
    style="
      background-image: url('../img/series/MsMarvel/principal.jpg');
      height: 400px;
      width: 100%;"
  >
        ...
        <div class="row">
          <div class="col-md-6 gx-5 mb-4">
            <div class="bg-image hover-overlay ripple shadow-2-strong rounded-5" data-mdb-ripple-color="light">
              <img src="../img/series//MsMarvel/Ms-Marvel-Principal.jpg" class="img-fluid" />
              <a href="#!">
          ...
          <div class="col-md-6 gx-5 mb-4">
            <h4><strong>Ms. Marvel</strong></h4>
            <p class="text-muted">
            Ms. Marvel é uma série de televisão na web americana, baseada na super-heroína da Marvel Comics de mesmo nome . É a décima nona série de televisão do Universo Cinematográfico Marvel e a décima segunda parte da Fase Quatro . A série é produzida pela Marvel Studios e foi lançada no Disney+ . 
            </p>
            <p><strong>A primeira e única temporada estreou em 8 de junho de 2022 e foi concluída em 13 de julho de 2022. Ela leva a The Marvels .</strong></p>
            <p class="text-muted">
            Ms. Marvel , da Marvel Studios , é uma nova série original que apresenta Kamala Khan , uma adolescente muçulmana americana que cresceu em Jersey City . Uma jogadora ávida e uma voraz escriba de fanfics, Kamala é uma mega fã de super-heróis com uma imaginação gigantesca – principalmente quando se trata de Capitã Marvel . No entanto, Kamala sente que não se encaixa na escola e às vezes até em casa - isto é, até obter super poderes como os heróis que ela sempre admirou. A vida fica melhor com super poderes, certo? 
            </p>
          </div>
        </div>
      </section>
...
<div class="row row-cols-1 row-cols-md-3 g-4" >
  <div class="col">
    <div class="card h-100 hover-zoom">
      <img src="../img/series/MsMarvel/01.jpg" class="card-img-top" alt="Hollywood Sign on The Hill"/>
      <div class="card-body">
        <ul class="mb-0 ms-2">
                    <li class="my-3">
                    Primeira temporada
                    ...
                    <li class="my-3">
                    8 de junho de 2022 - 13 de julho de 2022
                    </li>
                  </ul>
      </div>
    </div>
