...
<head>
    ...
    <title>Teorias Nerd/Séries/Manto e Adaga</title>
...
<div class="container my-5">
  ...
  <div
    ...
    style="
      background-image: url('../img/series/MantoEAdaga/principal.jpg');
      height: 400px;
      width: 100%;"
  >
    <div class="mask" style="background-color: rgba(0, 0, 0, 0.6);">
      <div class="d-flex justify-content-center align-items-center h-100">
        <div class="text-white">
          ...
          <h4 class="mb-3">Manto e Adaga</h4>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="row">
          <div class="col-md-6 gx-5 mb-4">
            <div class="bg-image hover-overlay ripple shadow-2-strong rounded-5" data-mdb-ripple-color="light">
              <img src="../img/series/MantoEAdaga/02.jpg" class="img-fluid" />
              <a href="#!">
          ...
          <div class="col-md-6 gx-5 mb-4">
            <h4><strong>Manto e Adaga</strong></h4>
            <p class="text-muted">
            Marvel's Cloak & Dagger , ou simplesmente Cloak & Dagger , é uma série de televisão americana baseada nos super-heróis da Marvel Comics de mesmo nome . É a décima primeira série de televisão do Universo Cinematográfico Marvel . Foi produzido pela Marvel Television e exibido na Freeform .
            </p>
            <p><strong>A primeira temporada estreou em 7 de junho de 2018 e foi concluída em 2 de agosto de 2018. A segunda temporada estreou em 4 de abril de 2019 e foi concluída em 30 de maio de 2019.</strong></p>
            <p class="text-muted">
            Tandy Bowen e Tyrone Johnson vêm de origens totalmente diferentes, cada um crescendo com um segredo que nunca ousaram compartilhar com outra alma.
            </p>
          </div>
        </div>
      </section>
...
<div class="row row-cols-1 row-cols-md-3 g-4" >
  <div class="col">
    <div class="card h-100 hover-zoom">
      <img src="../img/series/MantoEAdaga/001.jpg" class="card-img-top" alt="Hollywood Sign on The Hill"/>
      <div class="card-body">
        <ul class="mb-0 ms-2">
                    <li class="my-3">
                    Primeira temporada
                    ...
                    <li class="my-3">
                    Execução: 7 de junho de 2018 - 2 de agosto de 2018
                    </li>
                  </ul>
      </div>
    </div>
  ...
  <div class="col">
    <div class="card h-100 hover-zoom">
      <img src="../img/series/MantoEAdaga/002.jpg" class="card-img-top" alt="Palm Springs Road"/>
      <div class="card-body">
      <ul class="mb-0 ms-2">
                    <li class="my-3">
                    Segunda temporada
                    ...
                    <li class="my-3">
                    Execução: 4 de abril de 2019 - 30 de maio de 2019
                    </li>
                  </ul>
      </div>
    </div>
