...
<head>
    ...
    <title>Teorias Nerd/Séries/Agent Carter</title>
...
<div class="container my-5">
  ...
  <div
    ...
    style="
      background-image: url('../img/series/AgenteCarter/principal.jpg');
      height: 400px;
      width: 100%;"
  >
        ...
        <div class="row">
          <div class="col-md-6 gx-5 mb-4">
            <div class="bg-image hover-overlay ripple shadow-2-strong rounded-5" data-mdb-ripple-color="light">
              <img src="../img/series/AgenteCarter/banner.jpg" class="img-fluid" />
              <a href="#!">
          ...
          <div class="col-md-6 gx-5 mb-4">
            <h4><strong>Agente Carter</strong></h4>
            <p class="text-muted">
            Marvel's Agent Carter , ou simplesmente Agent Carter , é uma série de televisão americana baseada na personagem da Marvel Comics, Peggy Carter . É a segunda série de televisão do Universo Cinematográfico Marvel . Foi produzido pela Marvel Television e exibido na rede ABC .
            </p>
            <p><strong>Ele se passa após os eventos de Capitão América: O Primeiro Vingador e antes de Marvel One-Shot: Agent Carter .</strong></p>
            <p class="text-muted">
            A primeira temporada estreou em 6 de janeiro de 2015 e foi concluída em 24 de fevereiro de 2015. A segunda temporada estreou em 19 de janeiro de 2016 e foi concluída em 1º de março de 2016.
            <br>
            Em 12 de maio de 2016, a série foi cancelada pela ABC.
            </p>
          </div>
        </div>
      </section>
...
<div class="row row-cols-1 row-cols-md-3 g-4" >
  <div class="col">
    <div class="card h-100 hover-zoom">
      <img src="../img/series/AgenteCarter/01.jpg" class="card-img-top" alt="Hollywood Sign on The Hill"/>
      <div class="card-body">
        <ul class="mb-0 ms-2">
                    <li class="my-3">
                    Primeira temporada
                    ...
                    <li class="my-3">
                    Execução: 6 de janeiro de 2015 - 24 de fevereiro de 2015
                    </li>
                  </ul>
      </div>
    </div>
  ...
  <div class="col">
    <div class="card h-100 hover-zoom">
      <img src="../img/series/AgenteCarter/02.jpg" class="card-img-top" alt="Palm Springs Road"/>
      <div class="card-body">
      <ul class="mb-0 ms-2">
                    <li class="my-3">
                    Segunda temporada
                    ...
                    <li class="my-3">
                    Execução: 19 de janeiro de 2016 - 1º de março de 2016
                    </li>
                  </ul>
      </div>
    </div>
